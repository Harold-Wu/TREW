...
{# Generate full table.
  ...
  if (Content == "Default") {
    ...
    FullSpecific <- FullSpecific[, c("Species",	"Genome_assembly", "Gene_ID", "Meth_Range_ID", "Chromosome", 
                                     ...
                                     "Positivity", "Diff_log2FoldChange", "Consistency", "Overlap_UTR5", 
                                     "Overlap_CDS", "Overlap_UTR3", "Distance_ConsensusMotif", "Distance_StartCodon", 
                                     "Distance_StopCodon", "Paper", "Computation_pepline", "Date_of_process")]
  }
...
server <- shinyServer(function(input, output) {
  ...
  General_Table <<- reactive({GenerateGeneral(Species2 = input$Species_choice,
  ...
  Specific_Table <- reactive({GenerateSpecific(Species2 = input$Species_choice,
                                               Target2 = input$Regulation_choice,
                                               Modification2 = input$Modification_choice,
                                               Gene_ID2 = input$Gene_choice,
                                               Liftover2 = input$Liftover_choice,
